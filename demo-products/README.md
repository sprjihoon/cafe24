...
|---------------|-------------------|------------------|------------------------|--------|------|
| **OUTER** | 아우터 | **26** | `AN-OU-` | 4 | 재킷·코트·트렌치 |
| **TOP** | 상의 | **27** | `AN-TP-` | 6 | 니트·셔츠·블라우스·가디건 |
| **BOTTOM** | 하의 | **28** | `AN-BT-` | 5 | 슬랙스·스커트·데님 |
| **DRESS** | 원피스 *(신규 권장)* | **(미설정)** | `AN-DR-` | 4 | 데모몰에 전용 분류 없음 → 관리자에서 **원피스** 분류 생성 후 `cate_no` 기록 |
| **BAG** | 가방 *(신규 권장)* | **29** *(임시)* | `AN-AC-001`, `AN-AC-002` | 2 | 현재 **슈즈&백(29)** 에 임시 배치 가능. 가방 전용 하위 분류 생성 권장 |
| **SHOES** | 슈즈 *(신규 권장)* | **29** *(임시)* | `AN-AC-003`, `AN-AC-004` | 2 | 위와 동일. **슈즈&백** 하위에 **슈즈** 분류 분리 권장 |
